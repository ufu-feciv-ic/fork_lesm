...
% methods, declared in super-class *Print*, that deal with 2D truss
% analysis model of linear elements.
%
%% Class definition
% Definition of sub-class *Print_Truss2D* derived from super-class <print.html Print>.
classdef Print_Truss2D < Print
    %% Constructor method
    methods
        %------------------------------------------------------------------
        function print = Print_Truss2D(drv)
            print = print@Print(1);
    ...
    methods
        ...
        function nodalSupport(print)
            ...
            fprintf(print.txt, '------------------------------\n');
            fprintf(print.txt, ' NODE   DISPL X   DISPL Y\n');
        ...
        function nodalDisplRot(print)
            ...
            for n = 1:print.drv.nnp
                ...
                fprintf(print.txt, '%4d     %11.2f     %14.2f\n', n, dx, dy);
            end
        end
