...
% declared in super-class *Anm*, that deal with 2D truss analysis model
% of linear structure elements.
%
%% Truss 2D Analysis
% A 2D truss model is a common form of analysis model, with the following
% assumptions:
%%%
...
%
%% Class definition
% Definition of sub-class *Anm_Truss2D* derived from super-class <anm.html Anm>.
classdef Anm_Truss2D < Anm
    ...
    methods
        ...
        function anm = Anm_Truss2D()
            include_constants;
            anm = anm@Anm(TRUSS2D_ANALYSIS,2);
        end
    end
